	...
	<div class="searchPW-page">
		<div class="searchPW-Wrap">
			<form action="searchPW" method="post" name="searchPw">
				...
				<button type="button" value="찾기" onclick="pwSearch()">확인</button>

				<p class="aTags"><a class="message" href="/Medi3/searchPW">아이디 찾기</a> <a class="message" href="register.do">회원가입</a>
