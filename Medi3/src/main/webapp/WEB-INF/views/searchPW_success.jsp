...
<link rel="stylesheet" href="css/searchPW_success.css">
...
<section>
	<div>
		<div class="PWsuccess">
			<div class="PWsuccess-wrap">
				<p class="pwfind">[비밀번호 찾기]</p>
				회원님의 아이디는 <br>
				<h4 class="findPW">
				 <%
				 ...
				 <br><br>
				<button type="button" onclick="location.href='/Medi3/login.do' ">로그인하러 가기</button>
				<p class="aTags"><a class="message" href="/Medi3/home.do">홈으로</a></p>
			</div>
		</div>
	</div>
</section>
